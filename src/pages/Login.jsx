...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md animate-fade-in-up" style={{ animationDelay: '200ms' }}>
        ...
        <div className="relative bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="animate-fade-in-up" style={{ animationDelay: '300ms' }}>
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Mail className={`h-5 w-5 transition-colors ${isFocused.email ? 'text-blue-400' : 'text-slate-400'}`} />
                </div>
                <input
                  type="email"
                  value={form.email}
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: '400ms' }}>
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Lock className={`h-5 w-5 transition-colors ${isFocused.password ? 'text-purple-400' : 'text-slate-400'}`} />
                </div>
                <input
                  type="password"
                  value={form.password}
